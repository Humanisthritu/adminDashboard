...
const HomeSlides = () => {
    ...
    const columns = [
        { id: 'IMAGE', label: 'IMAGE', minWidth: 90 },
         { id: 'CATEGORY NAME', label: 'CATEGORY NAME', minWidth: 90 },
            ...
            <section className='w-full py-3 px-5'>
                <div className='flex items-center justify-between'>
                    ...
                    <Link href={"/category-list/add-category"}>
                      <Button className='btn-g' size='small'>Category Name</Button>
                    </Link>
                </div>
                                    ...
                                    <TableCell className='!px-0'>
                                        <div className='flex items-center gap-3'>
                                            <div className='img p-1 bg-white rounded-md'>
                                                <Image src={"/fruits&vegetables.png"} alt="product image" width={70} height={70} className='object-cover hover:scale-105 transition-all' />
                                            </div>
                                        </div>
                                    </TableCell>
